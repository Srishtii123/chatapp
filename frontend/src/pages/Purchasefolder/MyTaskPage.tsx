...
import Ponotgenerated from '../Purchasefolder/Ponotgenerated';
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <div style={{ flex: 1 }}>
        ...
        <div className="">
          {activeTab === 0 && <PurchaseRequestTab1 costUser={costUser} userlevel={gs_userlevel ?? 0} />}
          {activeTab === 1 && <MyTaskClosedRequestTab costUser={costUser} />}
          {activeTab === 2 && <MyitemPOConfirm costUser={costUser} userlevel={gs_userlevel ?? 0} />}
