...
const AccountsetupWmsPage = () => {
  ...
  const handleDeleteAccountsetup = async () => {
    await WmsSerivceInstance.deleteMasters('wms', 'accountsetup', Object.keys(rowSelection));
    setRowSelection({});
    refetchAccountsetupData();
  };
  ...
  const onGridReady = (params: any) => {
    ...
    console.log('Grid Data:', accountsetupData?.tableData);
  };
    ...
    <div className="flex flex-col space-y-2">
      <div className="flex justify-end space-x-2">
        ...
        <Button
          ...
          // variant="contained"
          onClick={() => toggleAccountsetupPopup()}
        >
          Account Setup
        </Button>
        {
      ...
      <CustomAgGrid
        rowData={accountsetupData?.tableData || []}
