...
const ManufactureWmsPage = () => {
  ...
  const handleDeleteManufacture = async () => {
    await WmsSerivceInstance.deleteMasters('wms', 'manufacture', Object.keys(rowSelection));
    setRowSelection({});
    refetchManufactureData();
  };
  ...
  const onGridReady = (params: any) => {
    ...
    console.log('Grid Data:', manufactureData?.tableData);
  };
    ...
    <div className="flex flex-col space-y-2">
      <div className="flex justify-end space-x-2">
        ...
        <Button
          ...
          onClick={() => toggleManufacturePopup()}
        >
          Manufacture
        </Button>
        {
      ...
      <CustomAgGrid
        rowData={manufactureData?.tableData || []}
