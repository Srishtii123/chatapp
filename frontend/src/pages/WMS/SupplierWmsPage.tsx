...
const SupplierWmsPage = () => {
  ...
  const onGridReady = (params: any) => {
    ...
    console.log('Grid Data:', supplierData?.tableData);
  };
  ...
  const handleDeleteSupplier = async () => {
    await WmsSerivceInstance.deleteMasters('wms', 'supplier', Object.keys(rowSelection));
    setRowSelection({});
    refetchSupplierData();
  };
  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <CustomAgGrid
        rowData={supplierData?.tableData || []}
