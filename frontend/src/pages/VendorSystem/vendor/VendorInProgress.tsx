...
const VendorInProgress = ({ triggerAddPopup, onAddPopupHandled }: VendorMainPgProps) => {
  ...
  const columnDefs = useMemo<ColDef[]>(
    () => [
      ...
      { field: 'REF_DOC_NO', headerName: 'Ref Doc No', sortable: true, filter: true, width: 140 },
      { field: 'INVOICE_NUMBER', headerName: 'Invoice Number', sortable: true, filter: true, width: 170 },
      {
        field: 'INVOICE_DATE',
