...
import type { AlmsSimpleMasterConfig } from "./AlmsMasterPage";
...
export const AlmsSimpleMasterConfigs: Record<string, AlmsSimpleMasterConfig> = {
  producttype: {
  ...
  subtitle: "Maintain item group codes and descriptions.",
  master: "item_group",
  gmEndpoint: "item_group",
  routeKeys: ["item_group"],
  keyField: "item_group_code",
  // formTabs: [
  //   { key: "basic", label: "Basic Info" },
  //   { key: "extra", label: "Extra Details" },
  // ],
  fields: [
    { name: "item_group_code", label: "Item Group Code", required: true, disabledOnEdit: true, width: 150 },
    { name: "item_group_name", label: "Item Group Name", required: true, width: 260 },
    { name: "item_group_desc", label: "Item Group Description", width: 280 },
  ],
