...
const MatClosed = () => {
 ...
 const { data: materialDataClosed, refetch: refetchMaterialData, } = useQuery({
    queryKey: ['materialDataClosed', searchData, paginationData],
   queryFn: () => PfSerivceInstance.getMasters('pf', 'Pg_Material_flow_Closed', paginationData, searchData, user?.loginid),
  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <CustomAgGrid
        rowData={materialDataClosed?.tableData || []}
