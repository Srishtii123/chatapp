...
const MatInProgress = () => {
  ...
  const { data: materialDataInProgress, refetch: refetchMaterialData, } = useQuery({
    queryKey: ['materialDataInProgress', searchData, paginationData],
   queryFn: () => PfSerivceInstance.getMasters('pf', 'Pg_Material_flow_InProgress', paginationData, searchData, user?.loginid),
  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <CustomAgGrid
        rowData={materialDataInProgress?.tableData || []}
