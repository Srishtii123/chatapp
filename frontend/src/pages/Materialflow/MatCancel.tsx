...
const MatCancel = () => {
  ...
  const { data: materialDataCancel, refetch: refetchMaterialDataCancel } = useQuery({
    queryKey: ['materialDataCancel', searchData, paginationData],
    queryFn: () => PfSerivceInstance.getMasters('pf', 'Pg_Material_flow_cancel', paginationData, searchData, user?.loginid),
    enabled: isQueryEnabled
  });

  // const { data: materialData, refetch: refetchMaterialData } = useQuery({
  //   queryKey: ['material_request_list'],
  //   queryFn: () => GmMatServiceInstance.MaterialRequestListing(),
  //   enabled: isQueryEnabled
  // });
  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <CustomAgGrid
        rowData={materialDataCancel?.tableData || []}
