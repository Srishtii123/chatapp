...
const ApproveLeaveResumption: FC<HRLInProgressProps> = ({}) => {
  const intl = useIntl();
  ...
  const [approveResumption, setApproveResumption] = useState(false);
  ...
  const {
    ...
    refetch: HRLInProgressDataRefetch,
    isError
  } = useQuery({
