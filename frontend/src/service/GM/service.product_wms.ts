...
class Product {
  ...
  deleteProduct = async (productCodes: string[]) => {
    try {
      const response: IApiResponse<null> = await axiosServices.post('api/wms/gm/product/delete', productCodes);
      if (response.data.success) {
        dispatch(
          openSnackbar({
            open: true,
  ...
  addBulkData = async (values: TProduct[]) => {
    try {
      const response: IApiResponse<null> = await axiosServices.post('api/wms/gm/product/bulk', values);
      if (response.data.success) {
        dispatch(
          openSnackbar({
            open: true,
