...
const BTHRLRejectedRequest: FC<HRLRejectedRequestProps> = ({ }) => {
  ...
  const {
    ...
    queryFn: () => BTHrServiceInstance.getMasters('hr', 'Pg_leave_flow_Rejected', paginationData, filterData, user?.loginid1),
...
export default BTHRLRejectedRequest;
