...
const BTHRLClosedRequest: FC<HRLClosedRequestProps> = ({}) => {
  const intl = useIntl();
  ...
  const {
    ...
    queryFn: () => BTHrServiceInstance.getMasters('hr', 'Pg_leave_flow_close', paginationData, filterData, user?.loginid1),
...
export default BTHRLClosedRequest;
