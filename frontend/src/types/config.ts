export type FontFamily = `'Segoe UI', sans-serif` |`'Inter', sans-serif` | `'Poppins', sans-serif` | `'Roboto', sans-serif` | `'Public Sans', sans-serif`;
...
export type CustomizationProps = {
  ...
  onChangeLocalization: (lang: I18n | string) => void;
