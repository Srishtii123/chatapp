...
const StockAgeingQuantityReport: React.FC = () => {
  const [reportId, setReportId] = useState<string>('');

  useEffect(() => {
    const fetchReportId = async () => {
      const response = await WmsServiceInstance.getAllDynamicReports(undefined, null, 'Stock Report', 'STOCK AGEING QUANTITY');
...
export default StockAgeingQuantityReport;
