...
import PRReportDetail from '../../forms/Purchaseflow/PRReportDetailView';
import PRReportSummary from '../../forms/Purchaseflow/PRReportSummaryView';
...
const PRSelectCriteria: React.FC = () => {
  ...
  const handleView = async () => {
    ...
    console.log('Payload being sent to backend:', params);
      ...
      <Box display="flex" flexDirection="column" gap={2} p={2}>
        ...
        <Box display="grid" gridTemplateColumns="repeat(2, 1fr)" gap={2}>
          ...
          <Autocomplete
            ...
            value={Array.isArray(requestStatus) ? requestStatus[0] : requestStatus}
        ...
        {showReport &&
          reportParams &&
          (reportType === 'Summary' ? (
            <PRReportSummary reportParams={reportParams} onClose={() => setShowReport(false)} />
          ) : (
            <PRReportDetail reportParams={reportParams} onClose={() => setShowReport(false)} />
          ))}
      </Box>
...
export default PRSelectCriteria;
