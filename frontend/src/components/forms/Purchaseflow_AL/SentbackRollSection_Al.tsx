...
const SentbackroleSectionAl: React.FC<SentbackroleSectionProps> = ({ onClose, flowLevel }) => {
  ...
  useEffect(() => {
    const fetchRoles = async () => {
      try {
        ...
        const data = await PfServiceInstance_Al.getSentbackrolls(app);
...
export default SentbackroleSectionAl;
