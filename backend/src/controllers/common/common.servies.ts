...
//   res.status(501).json({ success: false, message: "proc_build_dynamic_del_common is not implemented after Oracle -> MySQL migration" });
// };
...
//   res: Response
// ): Promise<void> => {
//   res.status(501).json({ success: false, message: "proc_build_dynamic_ins_upd_common is not implemented after Oracle -> MySQL migration" });
// };
