...
export const insUpdTteJOrderBulk = async (
  req: Request,
  res: Response
): Promise<void> => {


  console.log("insUpdTteJOrderBulk called-------------");
