...
export const insUpdTteTransferBulk = async (
  req: Request,
  res: Response
): Promise<void> => {


  console.log("insUpdTteTransferBulk called-------------");
  ...
  try {
    ...
    const headerRow = {
      ...
      FROM_ZONE_CODE:
        header.from_zone_code ?? null,



      TO_ZONE_CODE:
        header.to_zone_code ?? null,



      ISSUED_BY:
        header.issued_by ?? null,
