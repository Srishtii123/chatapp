...
export const insUpdTtePGrnBulk = async (
  req: Request,
  res: Response
): Promise<void> => {


  console.log("insUpdTtePGrnBulk called-------------");
