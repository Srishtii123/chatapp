...
export interface IToOrderEntry {
  ...
  pick_start: Date | string | null;
  pick_end: Date | string | null;
  pack_start: Date | string | null;
  pack_end: Date | string | null;
  load_start: Date | string | null;
  load_end: Date | string | null;
