...
export class JobOutboundWms {
  ...
  @Column({ name: "TRANSPORT_MODE", type: "char", length: 1, nullable: true })
  ...
  @Column({ name: "INSURANCE_VALUE", type: "float", nullable: true })
  insurance_value?: number;

  @Column({ name: "CUST_CODE", type: "varchar2", length: 20, nullable: true })
  cust_code?: string;

  @Column({ name: "CONTAINER_FLAG", type: "char", length: 1, nullable: true })
  container_flag?: string;

  @Column({ name: "CONTAINER", type: "char", length: 1, nullable: true })
  container?: string;

  @Column({ name: "PACKDET", type: "char", length: 1, nullable: true })
  packdet?: string;

  @Column({ name: "ALLOCATED", type: "char", length: 1, nullable: true })
  allocated?: string;

  @Column({ name: "CANCELED", type: "char", length: 1, nullable: true })
  canceled?: string;

  @Column({ name: "CONFIRMED", type: "char", length: 1, nullable: true })
  confirmed?: string;

  @Column({ name: "GRN_NO", type: "number", nullable: true })
  grn_no?: number;

  @Column({ name: "INVOICED", type: "char", length: 1, nullable: true })
  invoiced?: string;

  @Column({ name: "COMPLETED", type: "char", length: 1, nullable: true })
  completed?: string;

  @Column({ name: "EXP_JOBNO", type: "varchar2", length: 10, nullable: true })
  exp_jobno?: string;

  @Column({ name: "PICKED", type: "char", length: 1, nullable: true })
  picked?: string;

  @Column({ name: "ORDERED", type: "char", length: 1, nullable: true })
  ordered?: string;
  ...
  @Column({ name: "REEXPORT", type: "char", length: 1, nullable: true })
  reexport?: string;
  ...
  @Column({ name: "JOB_LOCK", type: "char", length: 1, nullable: true })
  job_lock?: string;
  ...
  @Column({ name: "CARGO_RECEIVED", type: "char", length: 1, nullable: true })
  ...
  @Column({ name: "SEND_MAIL", type: "char", length: 1, nullable: true })
  send_mail?: string;

  @Column({ name: "BACKLOG_MAIL", type: "char", length: 1, nullable: true })
  backlog_mail?: string;

  @Column({ name: "DPLAN_FLAG", type: "char", length: 1, nullable: true })
  dplan_flag?: string;

  @Column({ name: "TRANS_BATCH_ID", type: "varchar2", length: 20, nullable: true })
  trans_batch_id?: string;

  @Column({ name: "SEND_MAIL_DN", type: "char", length: 1, nullable: true })
  send_mail_dn?: string;

  @Column({ name: "KPI_INC", type: "char", length: 1, nullable: true })
  kpi_inc?: string;
